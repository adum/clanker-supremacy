...
function task_executor.advance_task_phase(builder_state, task, tick, ctx)
  ...
  if phase == "building" then
    ...
    elseif task.type == "place-layout-near-machine" or task.type == "place-output-belt-line" or task.type == "place-assembly-block" or task.type == "place-assembly-input-route" or task.type == "connect-assembly-power" then
