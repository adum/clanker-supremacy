...
$allCases = @(
  ...
  [pscustomobject]@{ Name = "clanker_artillery_placement"; RemoteSetupName = "setup_clanker_artillery_placement_test_case"; ServerPort = 34259; RemoteSetupArg = $null },
  ...
  [pscustomobject]@{ Name = "automation_science_lab_physical_feed"; RemoteSetupName = "setup_automation_science_lab_test_case"; ServerPort = 34258; RemoteSetupArg = $null; TimeoutSecs = 600 },
  [pscustomobject]@{ Name = "piercing_rounds_factory_physical_feed"; RemoteSetupName = "setup_piercing_rounds_factory_test_case"; ServerPort = 34260; RemoteSetupArg = $null; TimeoutSecs = 600 },
  ...
  [pscustomobject]@{ Name = "build_out_patrol_walks_to_ore_patch"; RemoteSetupName = "setup_build_out_patrol_walks_to_ore_patch_test_case"; ServerPort = 34255; RemoteSetupArg = $null; TimeoutSecs = 240 },
  [pscustomobject]@{ Name = "build_out_piercing_rounds_factory_after_research"; RemoteSetupName = "setup_build_out_piercing_rounds_factory_after_research_test_case"; ServerPort = 34261; RemoteSetupArg = $null; TimeoutSecs = 240 },
  ...
  [pscustomobject]@{ Name = "container_collection_inventory_caps"; RemoteSetupName = "setup_container_collection_inventory_caps_test_case"; ServerPort = 34256; RemoteSetupArg = $null },
