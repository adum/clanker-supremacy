...
$allCases = @(
  ...
  [pscustomobject]@{ Name = "solar_panel_factory_east_orientation_reports_blocker"; RemoteSetupName = "setup_solar_panel_factory_test_case_east"; ServerPort = 34240; RemoteSetupArg = $null },
  [pscustomobject]@{ Name = "solar_panel_factory_south_orientation_reports_blocker"; RemoteSetupName = "setup_solar_panel_factory_test_case_south"; ServerPort = 34245; RemoteSetupArg = $null },
  [pscustomobject]@{ Name = "solar_panel_factory_west_orientation_reports_blocker"; RemoteSetupName = "setup_solar_panel_factory_test_case_west"; ServerPort = 34246; RemoteSetupArg = $null },
  [pscustomobject]@{ Name = "solar_panel_factory_opposed_sources_reports_blocker"; RemoteSetupName = "setup_solar_panel_factory_opposed_sources_test_case"; ServerPort = 34243; RemoteSetupArg = $null },
  [pscustomobject]@{ Name = "solar_panel_factory_cross_pressure_anchor_blocker"; RemoteSetupName = "setup_solar_panel_factory_cross_pressure_test_case"; ServerPort = 34244; RemoteSetupArg = $null },
