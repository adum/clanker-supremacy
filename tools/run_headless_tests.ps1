...
$allCases = @(
  ...
  [pscustomobject]@{ Name = "output_belt_turn_avoids_resource_patch"; RemoteSetupName = "setup_output_belt_turn_avoids_resource_patch_test_case"; ServerPort = 34223; RemoteSetupArg = $null },
  [pscustomobject]@{ Name = "output_belt_layout_places_belts_before_inserter"; RemoteSetupName = "setup_output_belt_layout_places_belts_before_inserter_test_case"; ServerPort = 34226; RemoteSetupArg = $null },
