...
constants.clanker_artillery_shell_item_name = "clanker-artillery-shell"
constants.clanker_artillery_shell_starting_speed = 0.2
constants.clanker_artillery_shell_stack_size = 50
constants.clanker_artillery_fire_cooldown_multiplier = 2
